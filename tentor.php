...
<div class="content-wrapper">
	...
	<?php
		$dataKelas=$system->db->getAll("select a.* , b.mapel ,c.kelas,jenjang from tentor as a , mapel as b, kelas as c where a.mapel_id=b.mapel_id and b.kelas_id=c.kelas_id order by a.tentor_id DESC");
		...
		foreach($dataKelas as $r){
			$tabel.='<tr>
						...
						<td>'.$r['mapel'].' <span class="text-aqua">'.$r['kelas'].' '.$r['jenjang'].'</span></td>
						<td width="50" ><a href="tentor.edit.html?id='.$r['tentor_id'].'" class="btn btn-block btn-success"><i class="fa fa-edit"></i></a></td>
