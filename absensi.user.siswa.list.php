...
$idJadwal=$system->db->getOne('select jadwal_id from jadwal_siswa where id_jadwal_siswa='.$_GET['id']);
$jadwal=$system->db->getRow('select * from jadwal where jadwal_id='.$idJadwal);
...
<div class="content-wrapper">
	...
	<?php
		$dataKelas=$system->db->getAll('select * from absens_siswa where id_jadwal_siswa='.$_GET['id']);
		/* adodb_pr($data); */
		$no=1;
		$tabel='';
	...
	<a href="absensi.user.siswa.html" type="button" class="btn  btn-primary" >Kembali</a>
		<div class="box">
