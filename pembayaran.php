    ...
    <section class="content">
		<div class="box">
            <div class="box-header">
              <h3 class="box-title">Manage Pembayaran</h3>
            </div>
		...
		<?php
			...
			foreach($jadwal as $r){
				$html.='<tr>
							...
							<td>'.$r['semester'].'</td>
							<td>'.$r['tahunajaran'].'</td>
							<td width="100" ><a href="pembayaran.input.html?id='.$r['id_jadwal_siswa'].'" class="btn btn-info "  >Pembayaran</a></td>
							<td width="100"  ><a href="pembayaran.data.html?id='.$r['id_jadwal_siswa'].'" class="btn btn-success">Data Pebayaran</a> </td>
