...
--
-- Host: 127.0.0.1
-- Generation Time: 05 Nov 2018 pada 08.50
...
(1, 'K1800003', 'Kelas 6', 'SD'),
(2, 'K18SMP0004', 'kelas 3', 'SMP'),
...
(16, 'MPSMP0007', 'Matematika', 2),
(17, 'MPSMP0005', 'Bahasa Indonesia', 2),
(18, 'MPSMP0006', 'Bahasa Inggris', 2),
(20, 'MPSMP0004', 'IPA', 2),
(32, 'MPSD0001', 'Bahasa Indonesia1', 1),
(33, 'MPSD0001', 'Bahasa Indonesia1', 1),
(34, 'MPSD0002', 'Bahasa Indonesia1', 1),
(35, 'MPSMP0003', 'Bahasa Indonesia', 2);
...
INSERT INTO `siswa` (`id_siswa`, `kode`, `nama_siswa`, `alamat`, `gender`, `nama_ortu`, `no_hp`, `email`, `username`, `password`) VALUES
...
(4, '180001', 'andi wijang prasetyo', 'selorejo 09/01 madu, mojosongo, boyolali', 'L', 'ayah', '085647067303', 'andyprasetyo80@yahoo.co.id', 'admin', '21232f297a57a5a743894a0e4a801fc3'),
(5, '180002', 'tom-transport', 'Jl. Wahid Hasyim No. 8 Yogyakarta\r\nJl. KH Wahid Hasyim No.8, Condong Catur, Kec. Depok, Kabupaten Sleman', 'L', 'sdsd', '0274486107', 'mekiigiri66@gmail.com', 'admin', '21232f297a57a5a743894a0e4a801fc3');
...
INSERT INTO `tentor` (`tentor_id`, `kode`, `tentor_nama`, `tentor_alamat`, `tentor_telepon`, `mapel_id`, `tentor_username`, `tentor_password`) VALUES
(2, 'T0004', 'Yoga suara nada', 'Yogyakarta', '35436464', 2, 'yoga', '807659cd883fc0a63f6ce615893b3558'),
(3, 'T0003', 'Muhamad Dani Kurniaw', 'petung//31', '123456', 2, 'dani', '55b7e8b895d047537e672250dd781555'),
(6, 'T0002', 'Rendy', 'Yogyakarta', '35436464', 0, 'rendy', '88ad32a14f7f7964d03dad411ffcc59b'),
(7, 'T0001', 'hasan nur', 'bla', '123456', 0, 'andi', 'ce0e5bf55e4f71749eade7a8b95c4e46');
...
--
ALTER TABLE `mapel`
  MODIFY `mapel_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=36;
--
...
--
ALTER TABLE `tentor`
  MODIFY `tentor_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;