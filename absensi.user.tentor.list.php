...
$idJadwal=$system->db->getOne('select jadwal_id from detail_jadwal where detail_id='.$_GET['id']);
...
<div class="content-wrapper">
	...
	<?php
		$dataKelas=$system->db->getAll('select * from absensi_tentor where detail_id='.$_GET['id']);
		/* adodb_pr($data); */
		$no=1;
		$tabel='';
	...
	<a href="absesi.user.tentor.html" type="button" class="btn  btn-primary" >Kembali</a>
		<div class="box">
